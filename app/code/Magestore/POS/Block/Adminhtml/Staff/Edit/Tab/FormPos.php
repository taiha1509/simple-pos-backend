 ...
 */
class FormPos extends \Magento\Backend\Block\Widget\Grid\Extended implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    {
        return $this->getUrl('*/*/posId', ['id' => $this->getRequest()->getParam('id')]);
    }
